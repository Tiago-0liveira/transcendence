...
type SocketMessage =
	...
	| SocketMessageBase<"lobby-room-player-set-ready", { roomId: string, ready: boolean }>
	...
	| SocketMessageBase<"game-room-player-set-ready", { roomId: string, gameId: string, ready: boolean }>
	| SocketMessageBase<"game-room-data-update", Game>
	| SocketMessageBase<"game-room-player-input", { roomId: string, gameId: string, up: boolean, down: boolean }>

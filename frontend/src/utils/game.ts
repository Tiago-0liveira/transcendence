...
export const REFRESH_RATE_MS = 14 /* 14 ms makes the game run at more than 60fps */
...
export const updatePaddle = function (player: PlayerActiveGameData, up: boolean, down: boolean) {

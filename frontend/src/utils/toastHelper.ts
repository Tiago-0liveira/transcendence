...
export const toastHelper = {
	...
	friendRequest: (name: string, avatar: string, friendId: number) => {
		...
		`
		const acceptBtn = div.querySelector("button#toastify-btn-accept-request") as HTMLButtonElement
		acceptBtn.addEventListener("click", toastifyRequestAccept(friendId))
		
		const rejectBtn = div.querySelector("button#toastify-btn-reject-request") as HTMLButtonElement
